...
namespace paivaVersao0
{
    public partial class frmcontrolepedidos : MetroFramework.Forms.MetroForm
    {
        ...
        public void BuscarPorCodigo()
        {
            ...
            comando.CommandText = "SELECT idpedido,nomecliente,razaosocial,datapedido,urgencia,solicitante from cadpedido where @id=idpedido";
            ...
            while (reader.Read())
            {
                ...
                TABELA.Rows.Add(reader.GetString(0),reader.GetString(1), reader.GetString(2), reader.GetString(3), reader.GetString(4), reader.GetString(5));
            }
        ...
        {
            idpedido = txtCodigoPedido.Text;
            CadastroPedidos fmrpedido = new CadastroPedidos(idpedido);
            fmrpedido.Show();
        }
    }
}
