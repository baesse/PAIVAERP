...
namespace paivaVersao0.ClassesPrograma
{
    class PTSocietaria
    {
        ...
        public double participacaocapital { get; set; }
        ...
        public Boolean InserirNaBaseSociedade(PTSocietaria sociedade)
        {
            //try
           // {
                ...
                getcomando.Parameters.AddWithValue("idpedido", sociedade.idpedido);
